...
namespace ClinicSaaS.API.Migrations
{
    ...
    [Migration("20260910130816_AddClinicNotificationToggles")]
    partial class AddClinicNotificationToggles
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("ClinicSaaS.API.Data.Appointment", b =>
                {
                    ...
                    b.Property<Guid?>("CommissionSettlementId")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.HasIndex("CommissionSettlementId");
            ...
            modelBuilder.Entity("ClinicSaaS.API.Data.Clinic", b =>
                {
                    ...
                    b.Property<bool>("NotifyBefore12h")
                        .HasColumnType("bit");

                    b.Property<bool>("NotifyBefore1h")
                        .HasColumnType("bit");

                    b.Property<bool>("NotifyOnCancel")
                        .HasColumnType("bit");

                    b.Property<bool>("NotifyOnCreate")
                        .HasColumnType("bit");

                    b.Property<bool>("NotifyOnEdit")
                        .HasColumnType("bit");
            ...
            modelBuilder.Entity("ClinicSaaS.API.Data.Plan", b =>
                {
                    ...
                    b.Property<bool>("HasElectronicInvoicing")
                        .HasColumnType("bit");

                    b.Property<bool>("HasMultipleDepartments")
                        .HasColumnType("bit");
            ...
            modelBuilder.Entity("ClinicSaaS.API.Data.Appointment", b =>
                {
                    ...
                    b.HasOne("ClinicSaaS.API.Data.Settlement", "CommissionSettlement")
                        .WithMany()
                        .HasForeignKey("CommissionSettlementId")
                        .OnDelete(DeleteBehavior.NoAction);
                    ...
                    b.Navigation("CommissionSettlement");
            ...
            modelBuilder.Entity("ClinicSaaS.API.Data.InsuranceClaim", b =>
                {
                    ...
                    b.HasOne("ClinicSaaS.API.Data.Settlement", "Settlement")
                        .WithMany()
