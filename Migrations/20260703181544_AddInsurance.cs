        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CoverageRate = table.Column<decimal>(type: "decimal(5,2)", precision: 5, scale: 2, nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_InsuranceCompanies_Clinics_ClinicId",
                        column: x => x.ClinicId,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CoverageRate = table.Column<decimal>(type: "decimal(5,2)", precision: 5, scale: 2, nullable: false),
                    MaxCoverageAmount = table.Column<decimal>(type: "decimal(10,3)", precision: 10, scale: 3, nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_PatientInsurances_InsuranceCompanies_InsuranceCompanyId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PatientInsurances_InsuranceCompanyId",
