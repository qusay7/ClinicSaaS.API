...
{
    // هذا الكلاس يحدد فقط الحقول التي يحق للمستخدم إرسالها عند إنشاء مريض
    // لاحظ: لا يوجد Id, PatientNumber, isdeleted, CreatedAt
    // لأن هذه الحقول يحددها النظام تلقائياً وليس المستخدم
